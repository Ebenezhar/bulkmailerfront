...
function ResetPassword() {
    ...
    const formik = useFormik({
        initialValues: {
            firstName: `${userContextData.resetUser.firstName}`,
            secondName: `${userContextData.resetUser.secondName}`,
            email: `${userContextData.resetUser.email}`,
            age: `${userContextData.resetUser.age}`,
            country: `${userContextData.resetUser.country}`,
            gender: `${userContextData.resetUser.gender}`,
            password: "",
            verPassword: "",
        },
        validate: (values) => {
        ...
        onSubmit: async (values) => {
            try {
                console.log(values);
                let result = await axios.post(`${config.api}/reset/resetpassword`, values);
            ...
            <div className="max-w-5xl w-full mx-auto mt-4 bg-gray-800 p-8 rounded-2xl shadow-lg">
                ...
                <div className="flex flex-col justify-center items-start">
                    ...
                    >
                        ...
                        <button type={"submit"} className="w-1/6 sm:w-64 py-2 px-4 mt-4 ml-4 bg-gray-500 hover:bg-gray-600 rounded-md text-white text-lg">
                            Update
                        </button>
                    </form>
                </div>
